...
enum CameraAnimationTypes { NO_CAMERA_ANIMATION = -1, };
...
enum EffectTypes { NO_EFFECT = -1, };

enum AttachableTypes { NO_ATTACHABLE = -1, };
...
enum WidgetTypes // Exposed to Python
{
  ...
  //	This button type is reserved for widgets meant to be displayed only.  This is meant for general interface text
  // and such...
...
enum UnitArtStyleTypes { NO_UNIT_ARTSTYLE = -1, };
