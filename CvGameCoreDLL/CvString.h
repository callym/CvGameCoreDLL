...
//
// DON'T add any data members or virtual functions to these classes, so they stay the same size as their stl
// counterparts
//
// Mustafa Thamer
...
public:
  ...
  //	const CvString& operator=( const std::wstring& w) { Copy(w.c_str());	return *this; }		// don't want
  // accidental conversions down to narrow strings 	const CvString& operator=( const wchar* w) { Copy(w);	return
  // *this; }
